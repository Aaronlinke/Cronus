...
export default function OmnigenesisDashboard() {
  ...
  return (
    <div
      ...
      className="h-screen w-screen bg-[#030303] text-gray-200 p-3 md:p-4 flex flex-col gap-3 overflow-hidden"
    >
      <DashboardHeader clock={clock} kernel={kernel} target={target} />

      <div className="grid grid-cols-12 gap-3 flex-1 min-h-0">
        <div className="col-span-12 md:col-span-4 row-span-2 min-h-0 flex">
          <SultanTerminal target={target} />
        </div>

        <div className="col-span-12 md:col-span-5 min-h-0 flex">
          <ChronoField kernel={kernel} />
        </div>

        <div className="col-span-12 md:col-span-3 min-h-0 flex">
